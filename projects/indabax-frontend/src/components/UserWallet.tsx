...
import SAFlag from '../assets/SA_flag.svg'
...
const UserWallet: React.FC<UserWalletProps> = ({ onPremiumDeduction, onSettlement }) => {
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      <div className={`bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg shadow-lg border border-green-500/20 transition-all duration-300 ease-in-out ${
        isCollapsed ? 'p-2 min-w-[120px]' : 'p-4 min-w-[280px]'
      }`}>
        <div className="flex items-center justify-between mb-3">
          <h3 className={`font-semibold text-green-400 transition-all duration-300 ${
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="text-gray-400 hover:text-green-400 transition-colors duration-200 p-1 rounded hover:bg-gray-700"
            ...
            <div className="space-y-3">
              ...
              <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <img src={SAFlag} alt="South African flag" className="h-4 w-6 rounded-sm shadow" />
              ...
              <div className="bg-yellow-100 rounded-lg p-3 border border-yellow-300">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      <img src={USFlag} alt="United States flag" className="h-4 w-6 rounded-sm shadow" />
        ...
        {isCollapsed && (
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 text-xs text-gray-400 mb-1">
              <img src={SAFlag} alt="South African flag" className="h-3 w-5 rounded-sm" />
            </div>
            <div className="text-sm font-bold text-green-400">
              {formatCurrency(balances.zar, 'ZAR').replace('R', '')}
            </div>
            <div className="flex items-center justify-center gap-2 text-xs text-gray-400 mt-1 mb-1">
              <img src={USFlag} alt="United States flag" className="h-3 w-5 rounded-sm" />
            </div>
